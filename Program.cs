        ...
        static void ProcessByAction(string action, string xlsxPath, Dictionary<string, string> extraParameters, string ignoreDuplicates, NLog.Logger logger)
        {
            switch (action)
            {
                ...
                case "importcompanydirectives":
                    ...
                    break;
                case "importresourcecontractbases":
                    EntityProcessor.Process(typeof(ResourceContractBase), xlsxPath, Constants.SheetNames.ResourceContractBase, extraParameters, ignoreDuplicates, logger);
                    break;
                case "importresourceleaseagreements":
                    EntityProcessor.Process(typeof(ResourceLeaseAgreement), xlsxPath, Constants.SheetNames.ResourceLeaseAgreement, extraParameters, ignoreDuplicates, logger);
                    break;
                default:
                    break;
            }
