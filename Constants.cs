...
namespace ImportData
{
  class Constants
  {
    ...
    public class SheetNames
    {
      ...
      public const string ResourceContractBase = "Ресурсные договоры";
      public const string ResourceLeaseAgreement = "ДоговорПередачиРесурсовВАренду";
        }
    ...
    public class Actions
    {
      ...
      public const string ImportResourceContractBases = "importresourcecontractbases";
      public const string ImportResourceLeaseAgreements = "importresourceleaseagreements";
      ...
      public static Dictionary<string, string> dictActions = new Dictionary<string, string>
      {
        ...
        {ImportResourceContractBases, ImportResourceContractBases},
        {ImportResourceLeaseAgreements, ImportResourceLeaseAgreements}
      };
    }
